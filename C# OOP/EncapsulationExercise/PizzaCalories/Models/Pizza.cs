...
namespace PizzaCalories.Models
{
    public class Pizza
    {
        ...
        public double TotalCalories =>
            this.Dough.CaloriesPerGram + this.toppings.Sum(x => x.CaloriesPerGram);
        ...
        public void AddTopping(Topping topping)
        {
            ...
            {
                throw new ArgumentException(ExceptionMessages.InvalidTopingCount);
            }
        ...
        {
            if (targetName.Length > MaxNameLenght || targetName.Length < MinNameLenght || string.IsNullOrWhiteSpace(targetName))
            {
