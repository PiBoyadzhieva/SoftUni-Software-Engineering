namespace FastFood.Web.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public IActionResult Create(CreateOrderInputModel model)
        {
            ...
            Employee employee = this.context.Employees.FirstOrDefault(e => e.Name == model.EmployeeName);

            Item item = this.context.Items.FirstOrDefault(i => i.Name == model.ItemName);
