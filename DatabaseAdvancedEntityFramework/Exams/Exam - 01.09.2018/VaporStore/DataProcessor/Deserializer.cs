namespace VaporStore.DataProcessor
{
    ...
    using VaporStore.Data.Models.NewFolder;
    ...
    public static class Deserializer
	{
        ...
        public static string ImportUsers(VaporStoreDbContext context, string jsonString)
        {
            ...
            {
                if (!IsValid(userDto) || !userDto.Cards.All(IsValid) || userDto.Cards.Count() == 0)
                {
                    sb.AppendLine("Invalid Data");
                    continue;
                }
                ...
                {
                    var cardType = Enum.TryParse<CardType>(cardDto.Type, out CardType resultType);
        ...
        public static string ImportPurchases(VaporStoreDbContext context, string xmlString)
		{
            ...
            var purchasesDto = (ImportPurchaseDto[])xmlSerializer.Deserialize(reader);
            ...
            foreach (var purchaseDto in purchasesDto)
            {
                ...
                if(!isValidEnum || game == null || card == null)
                {
                    if (!isValidEnum)
                    {
                        sb.AppendLine("Invalid Data");
